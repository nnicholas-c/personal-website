...
export const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    company: "UC Berkeley Computational Biology Lab",
    description: [
      "Developed and analyzed nonlinear dynamical systems models in Python, C++, and MATLAB, including parameter sweeps and stability/sensitivity analysis.",
      "Built high-dimensional statistical learning pipelines with NumPy/Pandas/scikit-learn, applying PCA, k-means clustering, and Random Forest for candidate scoring.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.CPP,
